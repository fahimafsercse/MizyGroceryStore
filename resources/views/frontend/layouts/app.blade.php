...
<html>
<head>
<title>Mizy Grocery Store</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801621725075</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:mizystore@grocery.com">mizystore@grocery.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
